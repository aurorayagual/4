...
cargarEventListeners();
 ...
 function comprarElemento(e){
    ...
    if(e.traget.classList.contains('agregar-carrito')){
 ...
 function eliminarElemento(e){
    ...
    let elemento,
        ...
        if(e.traget.classList.contains('borrar')){
            e.traget.parentElement.parentElement.remove();
            elemento = e.traget.parentElement.parentElement;
